...
public /*abstract*/ interface Person {//it is not required to use abstract keyword with interface because it is redundancy
    ...
    //int age; //we can not have a field without a value because all the fields in interface should be public static and final
...
interface SyntaxEmployee extends Employee, Person{//this is multiple inheritance, M.I, is fixed with interfaces in Java
    void tech();
}
